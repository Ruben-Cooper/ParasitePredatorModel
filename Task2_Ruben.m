...
x_vals = linspace(0, 50, 1000);   
y_vals = 0.5367 * x_vals - 0.9190; % Using the equation of the line to get corresponding y values
plot(x_vals, y_vals, 'g', 'LineWidth', 4);  
axis([0 50 0 50]);

% Set labels, title and legend for the plot
fontsize = 20;
xlabel('k3', 'FontSize', fontsize);
ylabel('k4', 'FontSize', fontsize);
title('Impact of k3 and k4 on Parasite-Food Dynamics', 'FontSize', fontsize);
legend(' Case i', ' Case ii', ' Boundary ', 'Location', 'southoutside', 'FontSize', fontsize);
